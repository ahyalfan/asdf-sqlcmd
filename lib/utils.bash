...
# NOTE: You might want to remove this if sqlcmd is not hosted on GitHub releases.
...
list_all_versions() {
	...
	# Change this function if sqlcmd has other means of determining installable versions.
	list_github_tags
}
...
install_version() {
	...
	(
		...
		# TODO: Assert sqlcmd executable exists.
		local tool_cmd
